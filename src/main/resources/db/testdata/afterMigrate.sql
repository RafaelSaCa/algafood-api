...
insert into usuario_grupo (usuario_id, grupo_id) value (1,1),(1,2),(2,2);
...
values (1, '5a78ec6c-3612-11ee-be56-0242ac120002',1, 1, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801', 'Brasil',
...
insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep, 
                    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
	                status, data_criacao, subtotal, taxa_frete, valor_total)
values (2,'7825d7ac-3612-11ee-be56-0242ac120002', 4, 1, 2, 1, '38400-111', 'Rua Acre', '300', 'Casa 2', 'Centro',
